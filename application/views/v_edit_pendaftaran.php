                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url() . 'index.php/crud/update_pendaftaran' ?>">
                                <?php $no = 1;
                                foreach ($camaba as $u) { ?>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nama_ayah" value="<?php echo $u->nama_ayah; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputText" class="col-sm-2 col-form-label">Pekerjaan Ayah</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo $u->pekerjaan_ayah; ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputEmail" class="col-sm-2 col-form-label">Nama Ibu</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nama_ibu" value="<?php echo $u->nama_ibu; ?>">
                                        </div>
                                    </div>
                                    <div class=" row mb-3">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Pekerjaan Ibu</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo $u->pekerjaan_ibu; ?>">
                                        </div>
                                    </div>
                                    <div class=" row mb-3">
                                        <label for="inputNumber" class="col-sm-2 col-form-label">Alamat Orangtua</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="alamat_ortu" value="<?php echo $u->alamat_ortu; ?>">
                                        </div>
                                    </div>
                                    <h5 class="card-title">Edit data perkuliahan</h5>
